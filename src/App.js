...
function App() {
  const startDate = new Date(2024, 4, 28, 12, 30);
  const endDate2Weeks = new Date(2024, 5, 11, 12, 30);
  const endDate3Weeks = new Date(2024, 5, 18, 12, 30);
  const endDateMonth = new Date(2024, 5, 28, 12, 30);

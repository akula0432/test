...
function TwoWeeksComp({ startDate, endDate2Weeks }) {
  ...
  function result() {
    const final = getFinalMinutes(endDate2Weeks, startDate);
  ...
  return (
    <div>
      <div>{formatDate(endDate2Weeks)}</div>
